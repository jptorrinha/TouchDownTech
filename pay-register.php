      ...
      <div class="col-12">
        <form action="#" method="post" id="addPaymment" class="add-paymment">
          ...
          <div class="mb-3">
            ...
            <input type="hidden" class="form-control" id="player" name="player" value="<?php echo $_SESSION['id']; ?>">
            <input type="hidden" class="form-control" id="director" name="director" value="<?php echo $_SESSION['relTime']; ?>">
          </div>
