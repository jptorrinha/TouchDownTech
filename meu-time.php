        ...
        <div class="col-12">
          ...
          <form action="#" method="post" id="addTime" class="add-time">
            <div class="mb-3">
              ...
              <input type="hidden" class="form-control" id="director" name="director" value="<?php echo $_SESSION['id']; ?>">
            </div>
        ...
        <div class="col-12">
          <ul class="list-group list-payment">
            <?php while ($team = $stmt->fetch(PDO::FETCH_ASSOC)): ?>
              <li class="list-group-item"><?php echo $team['team_nome']; ?><br><hr><small>Diretor: <?php echo $team['team_id']; ?></small></li>
            <?php endwhile; ?>
          </ul>
        </div>  
      </div>
